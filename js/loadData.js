    ...
    htmlElements += `<div class="col-md-4 col-sm-6 portfolio-item">
                          ...
                          <div class="portfolio-caption">
                            ...
                            <p class="text-muted">
                              ...
                              <i class="fa fa-road"></i> Road Quality: ${Math.round(1000*(1-Number(data[i].road_quality_index)))/1000} <br />
                              <i class="fa fa-exclamation-triangle"></i> Jerk: ${Math.round(1000*data[i].jerk)/1000} <br />
                              <i class="fa fa-bolt"></i> Speed: ${Math.round(1000*data[i].speed_limit)/1000} <br />
